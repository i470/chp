...
(
	...
	quartile_25_rate float,
	quartile_50_rate float,
	quartile_75_rate float,
	quartile_100_rate float,
	cost float,
	report_date date,
...
(
	...
	lost_impression_share_budget float,
	lost_impression_share_rank float,
	clicks integer,
	ctr float,
...
(
	...
	post_view_conversions float,
	complete_views_video integer,
	insertion_order_status varchar,
	post_click_conversions float,
	completion_rate_video float,
	revenue_ecpa float,
	media_cost_ecpa float not null,
	media_cost float,
	total_media_cost float,
	client_id integer,
